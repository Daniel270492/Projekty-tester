...
public class conditionals {
    public static void main(String[] args) {
        ...
        // metoda equals pozwala na porównywanie String w Java w znacznie bezpieczniejszy sposób.
        // pierwszym elementem porownania jest zmienna - tutaj "slowo"
        // później po kropce używamy "equals"
        // equals wymaga parametru w cudzysłowiu, który zostanie porównany do wartości zmiennej. Tutaj jest to słowo "nic"
        if(slowo.equals("nic")){
